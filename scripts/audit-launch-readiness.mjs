...
addCheck("launch report export", launchComponent.includes("landly-beta-launch-report") && launchComponent.includes('version: "v54"'), "launch component exports v54 launch report");
...
addCheck("release metadata v54", release.includes('LANDLY_RELEASE_VERSION = "v54"') && release.includes("launch-control"), "release metadata describes v54 launch control");
