...
addCheck("operator snapshot export", dashboard.includes("landly-operator-snapshot") && dashboard.includes('version: "v54"'), "dashboard exports v54 operator snapshot");
...
addCheck("release metadata v54", release.includes('LANDLY_RELEASE_VERSION = "v54"') && release.includes("operator-insights"), "release metadata describes v54 admin insights");
