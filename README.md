...
Landly still uses fallback-first static/demo data for most place, map, refund, and medical flows. v52 focuses on beta launch readiness, not live data guarantees. Keep feedback API and provider integrations guarded until server-side ownership, privacy copy, and data policies are finalized.
